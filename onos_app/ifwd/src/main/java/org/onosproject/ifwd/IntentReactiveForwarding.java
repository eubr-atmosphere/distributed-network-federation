...
public class IntentReactiveForwarding {
    ...
    private boolean matchVlanId = true;
    ...
    private class ReactivePacketProcessor implements PacketProcessor {
        ...
        public void process(PacketContext context) {
            ...
            if (matchVlanId && ethPkt.getVlanID() != Ethernet.VLAN_UNTAGGED) {
                ...
                selector = DefaultTrafficSelector.builder().matchVlanId(VlanId.vlanId(ethPkt.getVlanID())).build();
            } else {
    ...
    private void setUpConnectivity(PacketContext context, HostId srcId, HostId dstId, TrafficSelector selector) {
